...
namespace SupportMe.Data
{
    ...
    public class EntityUnitOfWork : DbContext, IUnitOfWork
    {
        ...
        private IDbSet<InitialPresentation> initialPresentationRepository { get; set; }
        private IDbSet<Individual> individualRepository { get; set; }
        ...
        {
            initialPresentationRepository = this.Set<InitialPresentation>();
            InitialPresentationRepository = new Repository<InitialPresentation>(initialPresentationRepository);

            individualRepository = this.Set<Individual>();
            IndividualRepository = new Repository<Individual>(individualRepository); 
        ...
        /// <summary>
        /// Gets the IP repository
        /// </summary>
        public IRepository<InitialPresentation> InitialPresentationRepository { get; private set; }

        /// <summary>
        /// Gets or sets the Individuals Repository.
        /// </summary>
        public IRepository<Individual> IndividualRepository { get; set; }
